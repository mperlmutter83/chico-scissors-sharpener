...
const PHONE_DISPLAY = "(530) 444-1534";
const PHONE_HREF = "tel:+15304441534";
  ...
  if (status === "success") {
    return (
      <div className="text-center">
        ...
        <h3 className="mt-3 text-2xl font-serif text-ink">
          You&apos;re on the list!
        </h3>
        ...
        <p className="mt-4 text-neutral-600">
          Want to move faster?{" "}
          <a href={PHONE_HREF} className="font-bold text-teal-brand underline">
            Call {PHONE_DISPLAY}
          </a>
        </p>
      </div>
